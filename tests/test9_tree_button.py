...
class TreeButton:
    def __init__(self, text='', position=(0,0,0), parent_node=None,
                 ...
                 scale=(0.3, 0.05), expandable=True):
    ...
    def add_child(self, text, color=None):
        ...
        child = TreeButton(
            ...
            color=color,
            text_color=self.text_color,
            scale=(self.scale[0] * 0.9, self.scale[1] * 0.9),
            expandable=True
        )
...
# افزودن فرزندان سطح اول
child1 = root.add_child('Child 1', color=color.rgb(0.3, 0.6, 0.8))
child2 = root.add_child('Child 2', color=color.rgb(0.3, 0.6, 0.8))
child3 = root.add_child('Child 3', color=color.rgb(0.3, 0.6, 0.8))

# افزودن فرزندان به child1
grandchild1 = child1.add_child('Grandchild 1.1', color=color.rgb(0.4, 0.7, 0.9))
grandchild2 = child1.add_child('Grandchild 1.2', color=color.rgb(0.4, 0.7, 0.9))
grandchild3 = child1.add_child('Grandchild 1.3', color=color.rgb(0.4, 0.7, 0.9))

# افزودن فرزندان به child2
grandchild4 = child2.add_child('Grandchild 2.1', color=color.rgb(0.4, 0.7, 0.9))
